...
class RedisPermissionTest {

    RedisPermission redisPermission;
    ...
    void setUp() {
        ...
        redisPermission = new RedisPermission(new RedisTemplate<>());
    }
    ...
    @Test
    void getMenus() {
        Collection<? extends MenuInterface> menus = redisPermission.getMenus(null);
    }
