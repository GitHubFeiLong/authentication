        ...
        children: [
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        type: 2,
                        openModel: 0,
                        path: `/user/base-user/simple-create`,
                        method: '["POST"]',
                    ...
                    },
                    {
                        ...
                        type: 2,
                        openModel: 0,
                        path: '/user/base-user/simple-update',
                        method: '["PUT"]',
            ...
            },
            {
                ...
                type: 1,
                openModel: 0,
                component: () => import('@/secondaryLayout'),
                componentPath: '@/secondaryLayout',
                path: '/dict/management',
                // component: () => import('@/views/dict/index'),
                // componentPath: '@/views/dictType/index',
                permissionId: 'sys:dict:management',
                meta: {
                    title: '字典管理',
                ...
                children: [
                    {
                        ...
                        componentPath: '@/views/dictType/index',
                        permissionId: 'sys:dict:management:type',
                        meta: {
                            title: '类型管理',
                            icon: 'iconfont-zidianguanli',
                        },
                    },
                    {
                        ...
                        permissionId: 'sys:dict:management:dict',
                        meta: {
                            title: '字典管理',
                            icon: 'iconfont-zidianguanli',
                        },
                    },
                    {
                        ...
                        component: () => import('@/views/dictSetting/index'),
                        componentPath: '@/views/dictSetting/index',
                        permissionId: 'sys:dict:management:setting',
                        meta: {
                            title: '类型管理',
                            icon: 'iconfont-zidianguanli',
                        },
