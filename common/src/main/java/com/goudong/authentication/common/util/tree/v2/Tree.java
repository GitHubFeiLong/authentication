package com.goudong.authentication.common.util.tree.v2;


import com.goudong.authentication.common.function.SFunction;
import com.goudong.authentication.common.util.AssertUtil;
import com.goudong.authentication.common.util.CollectionUtil;
import com.goudong.authentication.common.util.ColumnUtil;
import com.goudong.authentication.common.util.tree.example.Menu;
...
public class Tree {
    ...
    public <E> List<E> toTree(List<E> nodes) {
        ...
        if (nodes.get(0) instanceof TreeInterface) {
