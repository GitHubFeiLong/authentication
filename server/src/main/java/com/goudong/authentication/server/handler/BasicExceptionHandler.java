...
public class BasicExceptionHandler implements HandlerInterface {
    ...
    public Result<Object> basicExceptionDispose(BasicException exception){
        // 设置响应码
    ...
    public Result<Object> runtimeExceptionDispose(RuntimeException exception){
    ...
    public Result<Object> throwableDispose(Throwable exception){
    ...
    public Result<Object> ValidExceptionDispose(Exception exception){
    ...
    public Result<Object> noHandlerFoundExceptionDispose(NoHandlerFoundException exception) {
        // 堆栈跟踪
    ...
    public Result<Object> httpRequestMethodNotSupportedExceptionDispose(HttpRequestMethodNotSupportedException exception) {
        // 堆栈跟踪
    ...
    public Result<Object> httpMediaTypeNotSupportedExceptionDispose(HttpMediaTypeNotSupportedException exception) {
        // 堆栈跟踪
