...
(
    ...
    CONSTRAINT `base_dict_ibfk_1` FOREIGN KEY (`dict_type_id`) REFERENCES `base_dict_type` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    KEY `dict_id` (`dict_id`),
    CONSTRAINT `base_dict_setting_ibfk_1` FOREIGN KEY (`dict_id`) REFERENCES `base_dict` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_bin
