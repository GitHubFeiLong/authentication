...
(
    ...
    `serial_number`      varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci   NOT NULL COMMENT '证书序号',
    ...
    `created_by`         varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL COMMENT '创建人',
    `last_modified_by`   varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL DEFAULT NULL COMMENT '修改人',
    PRIMARY KEY (`id`) USING BTREE,
  ...
  CHARACTER SET = utf8
  COLLATE = utf8_general_ci COMMENT = '应用证书密钥信息'
  ROW_FORMAT = Dynamic;
